...
— NEJM, 2012 [link](https://www.nejm.org/doi/10.1056/NEJMoa1203859)
...
A study’s design decides what it can really claim.
...
- *Synthesis* → pools evidence for stronger estimates.

**Observational**  
- **Cross-sectional** – snapshot at one point in time.  
- **Cohort (prospective)** – follow exposure over time to see who develops the outcome.  
- **Quasi-experimental** – natural assignment, no randomisation (e.g., policy change).

→ Useful for prevalence, trends, hypothesis generation; cannot on their own prove cause.

**Interventional**  
- **Pre–post / single-arm** – measure before-vs-after in same group.  
- **Randomised Controlled Trial** – participants randomly assigned; balances confounders.

→ Designed to answer causal questions and estimate treatment effect sizes.

**Evidence Synthesis**  
- **Meta-analysis** – combines comparable studies; increases power, tests consistency.

→ Highest in the evidence hierarchy when based on well-done RCTs; still limited by the quality and heterogeneity of included studies.
:::
...
- **Counts** – raw tally  
- **Percent / Proportion**  
- **Rates** – per population unit / time  
- **Standardised rates**  
...
- Always paired with an effect size  
- **p ≠ probability the result is true**

> “5 mm Hg drop, p = 0.03 → significant”
...
<small>Rule of thumb: if the 95 % CI crosses 0 (or 1 for ratios) the result is typically *not* statistically significant.</small>
...
**Publication bias** – Null results stay in file drawers; positive ones get published. Perhaps you'd take fewer supplements if all the no-effect studies were published.
