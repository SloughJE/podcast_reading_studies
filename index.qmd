...
6. **Red flags:** statistical 'tricks', sensational claims, or conflicts? 
...
2. **Know what kind of study you're looking at**   
   _Study design defines what it can show. Take into account the full body of evidence._
...
3. **Don't skip the statistics**  
   _Results are only as strong as the methods and statistical analysis behind it._
